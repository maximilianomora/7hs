...
/**
 * Strings for component 'theme_seven_hs', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>seven_hs</h2>
		<img src="seven_hs/pix/screenshot.png" />
	...
	<div class="theme_description">
		...
		<h2>About</h2>
		<p>seven_hs is a very clean and simple two-column, fluid-width theme for Moodle 2.0.</p>
...
$string['configtitle'] = 'seven_hs settings';
